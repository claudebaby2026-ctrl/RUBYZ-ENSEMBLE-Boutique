  ...
  return (
    <section className="grid gap-8 rounded-[2rem] border border-black/5 bg-white p-8 shadow-[0_20px_60px_rgba(17,17,17,0.06)] lg:grid-cols-[1.1fr_0.9fr] lg:p-16">
      ...
      >
        ...
        <h1 className="mb-6 text-4xl leading-tight text-[#111111] sm:text-5xl lg:text-6xl">Luxury ethnic fashion for every occasion.</h1>
        <p className="mb-8 max-w-xl text-base leading-7 text-gray-600">Discover handpicked silhouettes, premium fabrics, and concierge-level styling from the home of {brand.name}.</p>
