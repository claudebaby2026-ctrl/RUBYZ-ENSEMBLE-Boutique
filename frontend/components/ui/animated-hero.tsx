...
export function AnimatedHero({
        ...
        <div className="relative z-10 mx-auto flex min-h-[560px] max-w-7xl flex-col justify-between gap-6 px-5 py-10 sm:min-h-[620px] sm:gap-8 sm:px-8 sm:py-14 lg:min-h-[680px] lg:py-20">
          ...
          >
            ...
            <div className="flex flex-wrap gap-3 sm:gap-4">
              ...
              <Link href="/tailoring" className="inline-flex items-center gap-2 rounded-full border border-white/40 px-5 py-2.5 text-sm font-medium text-white transition hover:border-[#B17F5E] sm:px-6 sm:py-3"><Sparkles size={16} /> Tailoring Services</Link>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="max-w-xs rounded-[1.2rem] border border-white/10 bg-[#20130B]/80 p-5 backdrop-blur-sm sm:p-6"
          >
  ...
  return (
    <section className="mx-auto max-w-7xl px-5 py-10 lg:px-8 lg:py-16">
      <div className="grid gap-6 rounded-[1.5rem] border border-white/10 bg-[#20130B] p-5 shadow-[0_20px_60px_rgba(17,17,17,0.25)] sm:gap-8 sm:rounded-[2rem] sm:p-8 lg:grid-cols-[1.1fr_0.9fr] lg:p-16">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
