  ...
  return (
    <section className="grid gap-8 rounded-[2rem] border border-black/5 bg-white p-8 shadow-[0_20px_60px_rgba(17,17,17,0.06)] lg:grid-cols-[1.1fr_0.9fr] lg:p-16">
      ...
      >
        ...
        <h1 className="mb-6 text-4xl leading-tight text-[#111111] sm:text-5xl lg:text-6xl">
        ...
        <div className="flex flex-wrap gap-4">
          <Link
            href="/collections"
            className="inline-flex items-center gap-2 rounded-full bg-[#111111] px-6 py-3 text-sm font-medium text-white transition hover:translate-y-[-2px]"
          >
            Shop Now <ArrowRight size={16} />
          </Link>
          <Link
            href="/tailoring"
            className="inline-flex items-center gap-2 rounded-full border border-[#111111]/10 px-6 py-3 text-sm font-medium text-[#111111] transition hover:border-[#B68D40]"
          >
      ...
      >
        ...
        <div className="absolute inset-x-0 bottom-0 p-8">
          <p className="mb-3 text-xs uppercase tracking-[0.35em] text-[#F8F5F1]">
            Boutique Edit 2026
          </p>
