...
export function AnimatedProductCard({ product }: { product: Product }) {
  ...
  return (
    <Link href={`/products/${product.slug}`} className="block">
      ...
      >
        <div className="relative overflow-hidden rounded-[1rem] bg-[#EFE7DA] p-2 sm:rounded-[1.2rem] sm:p-4">
          ...
          {image ? (
            ...
            <div className="aspect-[3/4] w-full rounded-[0.8rem] bg-[linear-gradient(135deg,_#EFE7DA_0%,_#DCC9A8_100%)] sm:rounded-[1rem]" />
          )}
        ...
        <div className="px-1.5 pb-1.5 pt-3 sm:px-2 sm:pb-2 sm:pt-4">
          ...
          <span className="mt-1.5 block truncate text-sm text-[#111111] group-hover:text-[#B68D40] sm:mt-2 sm:text-lg">
            {product.name}
          </span>
